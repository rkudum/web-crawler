...
public class WebCrawlerControllerTests {
    ...
    @Test
    public void noParamWebCrawlerRequestShouldReturnWiproDigitalcom() throws Exception {

        this.mockMvc.perform(get("/webCrawler")).andDo(print()).andExpect(status().isOk())
    ...
    @Test
    public void paramWebCrawlerRequestShouldReturndomain() throws Exception {
